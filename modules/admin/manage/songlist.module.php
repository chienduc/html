...
$url = '/'.ADMIN_SCRIPT."?op=manage&act=product&mod=list&doo=$do&kw=$kw&lang=$lang&ipp=$items_per_page&sk=$sort_key&sd=$sort_direction&pId=$pId&pg=%d";
...
# Link
$link = '/'.ADMIN_SCRIPT."?op=manage&act=product&mod=list&kw=$kw&lang=$lang&ipp=$items_per_page&sk=$sort_key&sd=$sort_direction&pId=$pId&pg=$page";
...
if($_POST) {
	...
	header('location:'.'/'.ADMIN_SCRIPT."?op=manage&act=product&mod=list&doo=$do&kw=$kw&lang=$lang&ipp=$items_per_page&sk=$sort_key&sd=$sort_direction&pg=$page&ecode=$error_code&rcode=$result_code&pId=$pId");
} else {
