...
include_once(ROOT_PATH.'classes/dao/emailtemplateinfo.class.php');
...
class EmailTemplate extends Model {
	...
	function EmailTemplate($store_id = 0,$database = '') {
		if(!$database) {
			global $db;
			$this->_db = $db;
		...
		$this->table = DB_PREFIX."newstemplate";
