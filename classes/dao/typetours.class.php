...
include_once(ROOT_PATH."classes/dao/typetourinfo.class.php");

class Typetours extends Model {
	var $table;
	var $_db;

	function Typetours($database = '') {
		if(!$database) {
			global $db;
			$this->_db = $db;
		} else $this->_db = $database;
		$this->table = DB_PREFIX."typetour";
	}
