...
class CustomerInfo {
	...
	# Constructor
	function CustomerInfo($type, $username, $password, $fullname,$address,$email, $tel, $properties, $date_created, $last_login, $status, $areah, $area_id=0, $store_id = 0, $id = 0)
	{
		$this->id = $id;
