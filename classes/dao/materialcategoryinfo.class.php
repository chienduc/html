...
class MaterialCategoryInfo {
	...
	# Constructor
	function MaterialCategoryInfo($slug, $name, $keyword, $sapo, $position, $viewed, $properties, $status, $store_id = 0,$business = 0, $parent_id = 0, $id = 0)
	{
		$this->id = $id;
	...
	function getUrl($lang='vn') {
		$url = '';
	    $url = "/$lang/materials/".$this->slug.'-c'.$this->id.'.html';
		return $url;
