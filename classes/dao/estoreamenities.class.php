...
include_once(ROOT_PATH."classes/dao/estoreamenityinfo.class.php");

class EstoreAmenities extends Model {
	var $table;
	var $_db;
	
	function EstoreAmenities($database = '') {
		if(!$database) {
			global $db;
			$this->_db = $db;
		} else $this->_db = $database;
		$this->table = DB_PREFIX."estore_amenities";
	}
