...
include_once(ROOT_PATH.'classes/dao/activitiesinfo.class.php');
...
class Activities extends Model {
	...
	function Activities($store_id = 0, $database = '') {
		if(!$database) {
			global $db;
			$this->_db = $db;
		} else $this->_db = $database;
		$this->table = DB_PREFIX."activities";	
