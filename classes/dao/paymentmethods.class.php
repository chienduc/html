...
include_once(ROOT_PATH.'classes/dao/paymentmethodinfo.class.php');
...
class PaymentMethods extends Model {
	...
	function PaymentMethods($store_id = 0,$database = '') {
		if(!$database) {
			global $db;
			$this->_db = $db;
